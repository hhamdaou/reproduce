...
parser.add_option("--from-energy", type="float", default=100.*I3Units.GeV / I3Units.GeV,
...
if options.GCDFILE=="auto":
    gcdFilesDefault = {'IC86': expandvars("$I3_TESTDATA/GCD/GeoCalibDetectorStatus_IC86.55697_corrected_V2.i3.gz"),
...
if options.GENERATOR.lower() == "nugen":
    ...
    tray.AddSegment(segments.GenerateNeutrinos, "GenerateNeutrinos",
        ...
        GammaIndex = 1.,
        UseDifferentialXsection=False, 
	CrossSections='csms',
	CrossSectionsPath='/data/user/yxu/icesim_V050101/src/neutrino-generator/cross_section_data/',
...
final_outh5file=final_outfile.strip('.i3.zst')+'.h5'
basname=outfile.strip('.i3.zst')
hdffilename = basname + ".h5"
...
tray.Add('I3Reader', Filename=final_outfile)

tray.Add(I3SimHDFWriter,
    Output=final_outh5file,
    Keys=['I3MCWeightDict']    )

tray.Execute()
tray.Finish()
print("writing h5 done")
